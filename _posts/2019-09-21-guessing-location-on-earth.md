...
...And here we are!
![So far so good](images/2850 km circle.png)
...
![a time series! I feel at home](images/unfiltered signal.png)
...
```Python
from scipy impor signal # this library has the find_peaks function
...
![this is unhelpful](images/unfiltered signal with peaks.png)
...
![much better](images/filtered vs unfiltered.png)
...
![nice plots are what it's all about](images/smoothed with nice peaks.png)
